...
//kv storage
#define FLASH_KV_START                  (0x18002000)
#define FLASH_KV_SIZE                   (0x8000-0x2000)

//for kv configuration
#define KV_CONFIG_PARTITION             ( FLASH_DATA_USER_START )
#define KV_CONFIG_TOTAL_SIZE            ( FLASH_KV_SIZE )
