...
#if AT_CMD_DEBUG
#define AT_CMD_DEBUG_ERR    1
#define AT_CMD_DEBUG_WARN   0
#define AT_CMD_DEBUG_MSG    0
#endif
...
//httpc debug
#if HTTPC_DEBUG_EN
#define HTTPC_DEBUG_EN_ERR      1
#define HTTPC_DEBUG_EN_WARN     0
#define HTTPC_DEBUG_EN_MSG      0
#endif

#if HTTPC_DEBUG_EN_ERR
#define HTTP_ERR(fmt,arg...)    		S9070_ERR(httpc,fmt,##arg)
#else
#define HTTP_ERR(x, ...)
#endif

#if HTTPC_DEBUG_EN_WARN
#define HTTP_WARN(fmt,arg...)   		S9070_WARN(httpc,fmt,##arg)
#else
#define HTTP_WARN(x, ...)
#endif

#if HTTPC_DEBUG_EN_MSG
